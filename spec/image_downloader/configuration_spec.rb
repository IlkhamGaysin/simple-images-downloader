...
RSpec.describe ImageDownloader::Configuration do
  ...
  describe '.respond_to_missing?' do
    context 'when called method is present in ImageDownloader::ACCESSORS' do
      it 'responds to method' do
        expect(described_class).to respond_to(:destination)
      end
    end

    context 'when called method is not present in ImageDownloader::ACCESSORS' do
